#pragma checksum "C:\Users\ADMIN\source\repos\AsignmentWinUI\AsignmentWinUI\Views\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "2C09F34320572A3AD17E63BD2420098040EAC36CBD9B7DF315573A2BAFBAA795"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_ViewModel(global::AsignmentWinUI.ViewModels.MainViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_JoinChatPageCommand(obj.JoinChatPageCommand, phase);
                    }
                }
            }
            private void Update_ViewModel_JoinChatPageCommand(global::CommunityToolkit.Mvvm.Input.IRelayCommand obj, int phase)
            {
